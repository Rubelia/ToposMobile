 ...
 */
public class InsertCaBan_AsyncTask extends AsyncTask<String, CaBan, ArrayList<CaBan>> {

    private static String LOCATION = "DSCaBan_AsyncTask";
    //timer
    ...
    public InsertCaBan_AsyncTask (Activity ctx, CaBan in_CaBan) {
        contextCha = ctx;
...
//        this.IP = inputIP;
    ...
    protected void onPreExecute() {
        // TODO
        super.onPreExecute();
//        Toast.makeText(contextCha, "Đang ",
...
//        String URL = "http://192.168.200.31:80/MyService/tungSqlServerProxy.asmx";
        ...
        String script = "INSERT INTO [dbo].[CaBan] ([STT],[TenCaBan])" +
                "VALUES ('" + emp.getSTT() + "','" + emp.getTenCaBan()+ "') ";
...
//        adapter.notifyDataSetChanged();
    ...
    protected void onPostExecute(ArrayList<CaBan> result) {
        ...
        Toast.makeText(contextCha, "Insert thành công",
                Toast.LENGTH_SHORT).show();
    }
}
